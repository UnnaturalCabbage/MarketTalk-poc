export default class ViewModel extends HTMLElement {
    constructor() {
        super();
        this.state = {};
    }
    isCustomElement(element) {
        return Object.getPrototypeOf(Object.getPrototypeOf(customElements.get(element.tagName.toLowerCase()))).name === 'ViewModel';
    }
